...
ThemeData customDarkTheme = ThemeData(
  ...
  scaffoldBackgroundColor: const Color(0xFF121212), // Dark grey background instead of full black
  ...
  cardColor: const Color(0xFF1E1E1E), // Color for cards and containers
