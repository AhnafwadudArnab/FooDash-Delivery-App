...
import 'ProfileBar/Profilebar.dart';
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) {
                switch (_controller.selectedIndex) {
                  ...
                  case 1:
                    return const RecommendedFood(pageId: 1,); // Recommended Food Page
                  case 2:
                    return  const RecommendedFood(pageId: 0,); // Popular Food Details
                  case 3:
                    return const Center(
                      child: Text(
                        'Theme Settings',
