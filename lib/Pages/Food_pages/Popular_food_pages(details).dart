...
class PopularFoodPage extends StatefulWidget {
  ...
  const PopularFoodPage({super.key, required this.pageId}); // Constructor with required pageId
...
class _PopularFoodDetailsState extends State<PopularFoodDetails> {
  ...
  Container _buildAddToCartButton(Map<String, dynamic> foodItem) {
    ...
    SizedBox(height:Dimension.height49);
    return Container(
      padding: EdgeInsets.symmetric(
        vertical: Dimension.height20,
        horizontal: Dimension.width20,
      ...
      child: GestureDetector(
        ...
        child: BigText(
          text: "${foodItem['price']}tk | Add to Cart",
          color: Colors.white,
        ),
      ),
    );
