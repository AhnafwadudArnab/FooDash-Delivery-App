...
class RecommendedFood extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var foodItem = listfoodItems[pageId];
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    // Add functionality to decrease quantity via controller if needed
                  },
                  child: AppIcon(
                ...
                BigText(
                  text: "  1  ",  // Quantity can be managed via external state manager
                ),
                GestureDetector(
                  onTap: () {
                    // Add functionality to increase quantity via controller if needed
                  },
                  child: AppIcon(
                    iconSize: Dimension.iconsize24,
                    iconColor: Colors.white,
